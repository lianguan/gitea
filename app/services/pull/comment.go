...
func CreatePushPullComment(ctx context.Context, pusher *user_model.User, pr *issues_model.MergeRequest, oldCommitID, newCommitID string) (comment *issues_model.Comment, err error) {
