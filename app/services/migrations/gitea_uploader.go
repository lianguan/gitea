...
import (
	...
	base_module "gitmin.com/gitmin/app/modules/base"
	"gitmin.com/gitmin/app/modules/git"
	"gitmin.com/gitmin/app/modules/gitrepo"
	"gitmin.com/gitmin/app/modules/label"
	...
	"gitmin.com/gitmin/app/modules/uri"
...
func (g *GiteaLocalUploader) updateGitForPullRequest(pr *base.MergeRequest) (head string, err error) {
	...
	if pr.IsForkMergeRequest() && pr.State != "closed" {
