...
func SignMerge(ctx context.Context, pr *issues_model.MergeRequest, u *user_model.User, tmpBasePath, baseCommit, headCommit string) (bool, string, *git.Signature, error) {
